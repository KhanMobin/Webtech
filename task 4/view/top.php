...
<body>
	<fieldset>
		<div class="header">
			<div class="logo"; style="text-align: center"><img src="../use_img/logo.jpg" height="150px" width="200px"></div>
			<div class="navigation">
				<div class="home"; style="text-align: center"><a href="welcome.php">Home<span> |</span></a></div>
